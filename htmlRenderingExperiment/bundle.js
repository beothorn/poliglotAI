    ...
    document.getElementById('generate').addEventListener('click', async () => {
      ...
      try {
        ...
        const completion = await openai.chat.completions.create({
          ...
          messages: [{
            role: "system",
            content: "You are a Language Learning system. You render html and receives the input from the function r()." + "The output is always surrounded by STARTHTML and STOPHTML. For example, let`s say you are teaching articles, you first render: " + "STARTHTML <p>Bitte wählen Sie den richtigen Artikel für <strong>Freiheit</strong> aus:</p> " + "<button onclick=\"r('der')\">Der</button>" + "<button onclick=\"r('die')\">Die</button>" + "<button onclick=\"r('das')\">Das</button> " + "STOPHTML " + "Or maybe an input:STARTHTML<p>Input the German Article for Freiheit:</p>" + "<input type=\"text\" id=\"answerInput\" placeholder=\"Enter der, die, or das\">" + "<button onclick=\"r(document.getElementById('answerInput').value)\">Answer</button> " + "STOPHTML " + "Use wathever is best for the question. After you will get the output from the function r, for example:" + "der" + "STARTHTML<p>Tut mir leid, die Antwort ist der</p>" + "<p>Substantive mit den folgenden Suffixen haben den Artikel \"die\":</p>" + "<table border=\"1\"> <tr> <th>Suffix</th> <th>Beispiele</th> </tr>" + "<tr><td>-falt</td><td>Vielfalt</td></tr>" + "<tr><td>-heit</td><td>Freiheit, Sicherheit</td></tr>" + "<tr><td>-keit</td><td>Möglichkeit, Schnelligkeit</td></tr>" + "<tr><td>-schaft</td><td>Freundschaft, Mannschaft</td></tr>" + "<tr><td>-t (von Verben abgeleitete Substantive)</td><td>Fahrt, Tat</td></tr>" + "<tr><td>-ung</td><td>Leitung, Zeitung</td></tr>" + "</table>" + "<p>Lasst uns weitermachen. Bitte wählen Sie den richtigen Artikel für <strong>Apfell</strong> aus:</p>" + "<button onclick=\"r('der')\">Der</button>" + "<button onclick=\"r('die')\">Die</button>" + "<button onclick=\"r('das')\">Das</button> " + "STOPHTML " + "Student level is A2. Please give lengthy explanations before asking for a response."
          }, {
            role: "user",
            content: prompt
          }]
